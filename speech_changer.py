...
# from core.face.lipsync import LipSync  # Esta linha já está comentada.
...
def update_voice(voice_filename, video_filename, output_filename):
    ...
    # lip_sync = LipSync()  # Remova ou mantenha esta linha comentada.
    ...
    # Linha abaixo é onde a sincronização labial seria chamada; já está removida.
